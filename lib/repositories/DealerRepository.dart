...
Future<Review> addDealerReview(Review review, Dealer dealer) async {
  ...
  try {
    final response = await client.post(
      ...
      body: json.encode(review.ofDealerToMap(dealer)),
    );
    print("this is add restaurant review $url");
    print("this is add restaurant review body ${json.encode(review.ofDealerToMap(dealer))}");
